...
if (restaurants.features.length > 0 || (typeof userLat !== 'undefined' && userLat !== null && typeof userLng !== 'undefined' && userLng !== null)) {
    const bounds = new mapboxgl.LngLatBounds();

    // Duyệt qua tất cả các quán ăn trong kết quả tìm kiếm để lấy tọa độ
    if (restaurants.features && restaurants.features.length > 0) {
